...
class AuthController
{
    ...
    public function register(array $params): void
    {
        ...
        try {
            ...
            \TicketSpace\Utils\Database::rollback();
            \TicketSpace\Utils\Logger::error('Registration error', ['error' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
            Response::serverError('Registration failed: ' . $e->getMessage() . ' at ' . $e->getFile() . ':' . $e->getLine());
        }
    }
